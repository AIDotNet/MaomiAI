...
public static class TypeAsHelper
{
    ...
    public static TTargetValue? AS<TTargetValue>(string? sourceValue)
    {
        ...
        var c2 = Type.GetTypeCode(typeof(TTargetValue));
    ...
    {
        var c1 = Type.GetTypeCode(typeof(TSourceValue));
        var c2 = Type.GetTypeCode(typeof(TTargetValue));
