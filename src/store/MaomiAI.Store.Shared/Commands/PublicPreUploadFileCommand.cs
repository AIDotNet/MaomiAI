...
public class PublicPreUploadFileCommand : IRequest<PreUploadFileCommandResponse>
{
    /// <summary>
    /// 文件名称.
    /// </summary>
...
public class UploadTeamAvatarCommandValidator : AbstractValidator<PublicPreUploadFileCommand>
{
    public UploadTeamAvatarCommandValidator()
    {
