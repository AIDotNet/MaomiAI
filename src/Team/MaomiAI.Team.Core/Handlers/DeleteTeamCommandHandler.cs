...
/// 处理删除团队命令.
/// </summary>
public class DeleteTeamCommandHandler : IRequestHandler<DeleteTeamCommand, EmptyCommandResponse>
{
    ...
    public async Task<EmptyCommandResponse> Handle(DeleteTeamCommand request, CancellationToken cancellationToken)
    {
