// <copyright file="QueryAiModelFunctionListCommandEndpoint.cs" company="MaomiAI">
...
public class QueryAiModelFunctionListCommandEndpoint : Endpoint<QueryAiModelFunctionListCommand, QueryAiModelFunctionListCommandResponse>
{
    ...
    public QueryAiModelFunctionListCommandEndpoint(IMediator mediator, UserContext userContext)
    {
        _mediator = mediator;
