...
/**
 * Builds and executes requests for operations under /api/wiki/{temaId}/document/list
 */
 ...
 */
export const ListRequestBuilderUriTemplate = "{+baseurl}/api/wiki/{temaId}/document/list";
/**
