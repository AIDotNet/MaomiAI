...
/**
 * Builds and executes requests for operations under /api/team/{teamId}/member/invite
 */
 ...
 */
export const InviteRequestBuilderUriTemplate = "{+baseurl}/api/team/{teamId}/member/invite";
/**
