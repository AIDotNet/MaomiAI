...
// @ts-ignore
import { createBusinessExceptionResponseFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializeUploadTeamAvatarCommand, type BusinessExceptionResponse, type EmptyCommandResponse, type UploadTeamAvatarCommand } from '../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/team/{teamId}/config/uploadavatar
 */
export interface UploadavatarRequestBuilder extends BaseRequestBuilder<UploadavatarRequestBuilder> {
     ...
     */
     post(body: UploadTeamAvatarCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 上传头像.
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: UploadTeamAvatarCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const UploadavatarRequestBuilderUriTemplate = "{+baseurl}/api/team/{teamId}/config/uploadavatar";
/**
...
export const UploadavatarRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeUploadTeamAvatarCommand,
