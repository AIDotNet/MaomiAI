...
/**
 * Builds and executes requests for operations under /api/team/{teamId}/setadmin
 */
 ...
 */
export const SetadminRequestBuilderUriTemplate = "{+baseurl}/api/team/{teamId}/setadmin";
/**
