...
// @ts-ignore
import { createBusinessExceptionResponseFromDiscriminatorValue, createIdResponseFromDiscriminatorValue, serializeCreateNoteCommand, serializeIdResponse, type BusinessExceptionResponse, type CreateNoteCommand, type IdResponse } from '../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/note/create
 */
export interface CreateRequestBuilder extends BaseRequestBuilder<CreateRequestBuilder> {
     ...
     */
     post(body: CreateNoteCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<IdResponse | undefined>;
    /**
     * 新建一个笔记.
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: CreateNoteCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const CreateRequestBuilderUriTemplate = "{+baseurl}/api/note/create";
/**
...
export const CreateRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeCreateNoteCommand,
