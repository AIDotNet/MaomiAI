...
/**
 * Instantiates a new {@link MaomiClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createMaomiClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<MaomiClient>(requestAdapter, pathParameters, MaomiClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface MaomiClient extends BaseRequestBuilder<MaomiClient> {
    /**
     * The api property
     */
 ...
 */
export const MaomiClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const MaomiClientNavigationMetadata: Record<Exclude<keyof MaomiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
