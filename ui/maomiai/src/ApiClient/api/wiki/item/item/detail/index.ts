...
// @ts-ignore
import { createMaomiAIDocumentSharedQueriesResponseQueryWikiDetailInfoResponseFromDiscriminatorValue, createMaomiAIInfraModelsBusinessExceptionResponseFromDiscriminatorValue, type MaomiAIDocumentSharedQueriesResponseQueryWikiDetailInfoResponse, type MaomiAIInfraModelsBusinessExceptionResponse } from '../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/wiki/{teamId}/{wikiId}/detail
 */
export interface DetailRequestBuilder extends BaseRequestBuilder<DetailRequestBuilder> {
    /**
     * 知识库详细信息.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<MaomiAIDocumentSharedQueriesResponseQueryWikiDetailInfoResponse>}
     ...
     */
     post(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<MaomiAIDocumentSharedQueriesResponseQueryWikiDetailInfoResponse | undefined>;
    /**
     * 知识库详细信息.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const DetailRequestBuilderUriTemplate = "{+baseurl}/api/wiki/{teamId}/{wikiId}/detail";
/**
...
export const DetailRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createMaomiAIDocumentSharedQueriesResponseQueryWikiDetailInfoResponseFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
