...
// @ts-ignore
import { createBusinessExceptionResponseFromDiscriminatorValue, createQueryWikiDetailInfoResponseFromDiscriminatorValue, type BusinessExceptionResponse, type QueryWikiDetailInfoResponse } from '../../../../../models/index.js';
// @ts-ignore
...
export interface DetailRequestBuilder extends BaseRequestBuilder<DetailRequestBuilder> {
     ...
     */
     post(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<QueryWikiDetailInfoResponse | undefined>;
    /**
     * 知识库详细信息.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
