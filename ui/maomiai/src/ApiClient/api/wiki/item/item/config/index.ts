...
// @ts-ignore
import { createBusinessExceptionResponseFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, createQueryWikiConfigCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializeUpdateWikiConfigCommand, type BusinessExceptionResponse, type EmptyCommandResponse, type QueryWikiConfigCommandResponse, type UpdateWikiConfigCommand } from '../../../../../models/index.js';
// @ts-ignore
...
export interface ConfigRequestBuilder extends BaseRequestBuilder<ConfigRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<QueryWikiConfigCommandResponse | undefined>;
    /**
     * 更新知识库的配置.
