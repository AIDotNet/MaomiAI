...
export interface Upload_avatarRequestBuilder extends BaseRequestBuilder<Upload_avatarRequestBuilder> {
     ...
     */
     post(body: MaomiAIDocumentSharedCommandsUploadWikiAvatarCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<MaomiAIInfraModelsEmptyCommandResponse | undefined>;
    /**
     * 完成头像上传.
     * @param body 上传知识库头像.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: MaomiAIDocumentSharedCommandsUploadWikiAvatarCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
...
export const Upload_avatarRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeMaomiAIDocumentSharedCommandsUploadWikiAvatarCommand,
