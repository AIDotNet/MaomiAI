...
/**
 * Builds and executes requests for operations under /api/wiki/{teamId}/{wikiId}/document/search
 */
 ...
 */
export const SearchRequestBuilderUriTemplate = "{+baseurl}/api/wiki/{teamId}/{wikiId}/document/search";
/**
