...
// @ts-ignore
import { createMaomiAIInfraModelsBusinessExceptionResponseFromDiscriminatorValue, createMaomiAIInfraModelsIdResponseFromDiscriminatorValue, serializeMaomiAIDocumentSharedCommandsCreateWikiCommand, serializeMaomiAIInfraModelsIdResponse, type MaomiAIDocumentSharedCommandsCreateWikiCommand, type MaomiAIInfraModelsBusinessExceptionResponse, type MaomiAIInfraModelsIdResponse } from '../../../../models/index.js';
// @ts-ignore
...
export interface CreateRequestBuilder extends BaseRequestBuilder<CreateRequestBuilder> {
     ...
     */
     post(body: MaomiAIDocumentSharedCommandsCreateWikiCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<MaomiAIInfraModelsIdResponse | undefined>;
    /**
     * 创建知识库.
     * @param body 创建知识库.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: MaomiAIDocumentSharedCommandsCreateWikiCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
...
export const CreateRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeMaomiAIDocumentSharedCommandsCreateWikiCommand,
