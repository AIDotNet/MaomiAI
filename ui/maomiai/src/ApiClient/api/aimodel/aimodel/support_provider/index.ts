...
/**
 * Builds and executes requests for operations under /api/aimodel/aimodel/support_provider
 */
 ...
 */
export const Support_providerRequestBuilderUriTemplate = "{+baseurl}/api/aimodel/aimodel/support_provider";
/**
