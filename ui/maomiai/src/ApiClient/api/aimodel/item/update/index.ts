...
// @ts-ignore
import { createBusinessExceptionResponseFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializeUpdateAiEndpointRequest, type BusinessExceptionResponse, type EmptyCommandResponse, type UpdateAiEndpointRequest } from '../../../../models/index.js';
// @ts-ignore
...
export interface UpdateRequestBuilder extends BaseRequestBuilder<UpdateRequestBuilder> {
     ...
     */
     post(body: UpdateAiEndpointRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 修改 AI 模型信息，key 要使用 RSA 公钥加密，如果不修改 key 需设置 key=*.
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: UpdateAiEndpointRequest, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
...
export const UpdateRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeUpdateAiEndpointRequest,
