...
/**
 * Builds and executes requests for operations under /api/aimodel/{teamId}/aimodel/support_provider
 */
 ...
 */
export const Support_providerRequestBuilderUriTemplate = "{+baseurl}/api/aimodel/{teamId}/aimodel/support_provider";
/**
