...
/**
 * Builds and executes requests for operations under /api/aimodel/{teamId}/admodel/update
 */
 ...
 */
export const UpdateRequestBuilderUriTemplate = "{+baseurl}/api/aimodel/{teamId}/admodel/update";
/**
