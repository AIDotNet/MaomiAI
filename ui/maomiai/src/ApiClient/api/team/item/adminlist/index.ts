...
// @ts-ignore
import { createMaomiAITeamSharedQueriesResponsesTeamMemberResponseFromDiscriminatorValue, type MaomiAITeamSharedQueriesResponsesTeamMemberResponse } from '../../../../models/index.js';
// @ts-ignore
