...
// @ts-ignore
import { createBusinessExceptionResponseFromDiscriminatorValue, createEmptyDtoFromDiscriminatorValue, serializeEmptyDto, serializeUpdateTeamInfoCommand, type BusinessExceptionResponse, type EmptyDto, type UpdateTeamInfoCommand } from '../../../../models/index.js';
// @ts-ignore
...
export interface UpdateRequestBuilder extends BaseRequestBuilder<UpdateRequestBuilder> {
     ...
     */
     post(body: UpdateTeamInfoCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyDto | undefined>;
    /**
     * 更新团队信息.
     * @param body 更新团队信息命令.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const UpdateRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createEmptyDtoFromDiscriminatorValue,
