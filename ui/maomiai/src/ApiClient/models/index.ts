 ...
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 * @returns {MaomiAIInfraModelsErrorResponse_errors}
 */
// @ts-ignore
export function createMaomiAIInfraModelsErrorResponse_errorsFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoMaomiAIInfraModelsErrorResponse_errors;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 * @returns {MaomiAIInfraModelsErrorResponse_extensions}
 */
// @ts-ignore
export function createMaomiAIInfraModelsErrorResponse_extensionsFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoMaomiAIInfraModelsErrorResponse_extensions;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 * @returns {MaomiAIInfraModelsErrorResponse}
 */
// @ts-ignore
export function createMaomiAIInfraModelsErrorResponseFromDiscriminatorValue(parseNode: ParseNode | undefined) : ((instance?: Parsable) => Record<string, (node: ParseNode) => void>) {
    return deserializeIntoMaomiAIInfraModelsErrorResponse;
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 ...
 */
// @ts-ignore
export function deserializeIntoMaomiAIInfraModelsErrorResponse(maomiAIInfraModelsErrorResponse: Partial<MaomiAIInfraModelsErrorResponse> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        "code": n => { maomiAIInfraModelsErrorResponse.code = n.getNumberValue(); },
        "detail": n => { maomiAIInfraModelsErrorResponse.detail = n.getStringValue(); },
        "errors": n => { maomiAIInfraModelsErrorResponse.errors = n.getObjectValue<MaomiAIInfraModelsErrorResponse_errors>(createMaomiAIInfraModelsErrorResponse_errorsFromDiscriminatorValue); },
        "extensions": n => { maomiAIInfraModelsErrorResponse.extensions = n.getObjectValue<MaomiAIInfraModelsErrorResponse_extensions>(createMaomiAIInfraModelsErrorResponse_extensionsFromDiscriminatorValue); },
        "requestId": n => { maomiAIInfraModelsErrorResponse.requestId = n.getStringValue(); },
    }
}
/**
 * The deserialization information for the current model
 ...
 */
// @ts-ignore
export function deserializeIntoMaomiAIInfraModelsErrorResponse_errors(maomiAIInfraModelsErrorResponse_errors: Partial<MaomiAIInfraModelsErrorResponse_errors> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
    }
}
/**
 ...
 */
// @ts-ignore
export function deserializeIntoMaomiAIInfraModelsErrorResponse_extensions(maomiAIInfraModelsErrorResponse_extensions: Partial<MaomiAIInfraModelsErrorResponse_extensions> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
    }
}
/**
 ...
 * 错误响应模型.
 */
export interface MaomiAIInfraModelsErrorResponse extends ApiError, Parsable {
    /**
     * 错误码.
     */
    code?: number | null;
     ...
     * 具体错误列表.
     */
    errors?: MaomiAIInfraModelsErrorResponse_errors | null;
    /**
     * 扩展.
     */
    extensions?: MaomiAIInfraModelsErrorResponse_extensions | null;
    /**
     * 请求上下文 ID.
     */
 ...
 * 具体错误列表.
 */
export interface MaomiAIInfraModelsErrorResponse_errors extends Parsable {
}
/**
 * 扩展.
 */
export interface MaomiAIInfraModelsErrorResponse_extensions extends Parsable {
}
/**
 * 数据是否存在.
 */
 ...
 */
// @ts-ignore
export function serializeMaomiAIInfraModelsErrorResponse(writer: SerializationWriter, maomiAIInfraModelsErrorResponse: Partial<MaomiAIInfraModelsErrorResponse> | undefined | null = {}) : void {
    if (maomiAIInfraModelsErrorResponse) {
        writer.writeNumberValue("code", maomiAIInfraModelsErrorResponse.code);
        writer.writeStringValue("detail", maomiAIInfraModelsErrorResponse.detail);
        writer.writeObjectValue<MaomiAIInfraModelsErrorResponse_errors>("errors", maomiAIInfraModelsErrorResponse.errors, serializeMaomiAIInfraModelsErrorResponse_errors);
        writer.writeObjectValue<MaomiAIInfraModelsErrorResponse_extensions>("extensions", maomiAIInfraModelsErrorResponse.extensions, serializeMaomiAIInfraModelsErrorResponse_extensions);
        writer.writeStringValue("requestId", maomiAIInfraModelsErrorResponse.requestId);
    }
}
/**
 * Serializes information the current object
 ...
 */
// @ts-ignore
export function serializeMaomiAIInfraModelsErrorResponse_errors(writer: SerializationWriter, maomiAIInfraModelsErrorResponse_errors: Partial<MaomiAIInfraModelsErrorResponse_errors> | undefined | null = {}) : void {
    if (maomiAIInfraModelsErrorResponse_errors) {
    }
}
/**
 * Serializes information the current object
 ...
 */
// @ts-ignore
export function serializeMaomiAIInfraModelsErrorResponse_extensions(writer: SerializationWriter, maomiAIInfraModelsErrorResponse_extensions: Partial<MaomiAIInfraModelsErrorResponse_extensions> | undefined | null = {}) : void {
    if (maomiAIInfraModelsErrorResponse_extensions) {
    }
}
/**
 * Serializes information the current object
